    ...
    <c:param name="content">
        <c:choose>
            <c:when test="${report != null}">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:when test="${report.like_count == 0}">
                                    <c:out value="${report.like_count}" /></c:when>
                                <c:otherwise>
                                    <pre><a href="<c:url value='/reports/like_employees?id=${report.id}' />">${report.like_count}</a></pre></c:otherwise>
                                </c:choose>
                            </td>
                        </tr>
                        <tr>
                ...
                <c:if test="${report.approval == 2 && report.employee.name == login_employee}">
                <br>
