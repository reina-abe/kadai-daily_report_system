...
@NamedQueries({
    ...
    @NamedQuery(
            ...
            query = "SELECT e FROM Employee AS e WHERE e.position < :login_employee"
            ),
    @NamedQuery(
            name = "getEmployeesAttendanceCount",
            query = "SELECT COUNT(e) FROM Employee AS e WHERE e.position < :login_employee"
            )
})
@Entity
